...
namespace SIS.WebServer
{
    public class ConnectionHandler
    {
        ...
        private void PrepareResponse(IHttpResponse httpResponse)
        {
            ...
            this.client.SendAsync(byteSegments, SocketFlags.None);
        }
        ...
        private void SetResponseSession(IHttpResponse httpResponse, string sesstionId)
        {
            if(sesstionId != null)
            {
                httpResponse.AddCookie(new HttpCookie(HttpSessionStorage.SessionCookieKey, sesstionId));
            }
        }
