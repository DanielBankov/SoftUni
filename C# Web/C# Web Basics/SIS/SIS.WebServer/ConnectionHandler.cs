...
namespace SIS.WebServer
{
    public class ConnectionHandler
    {
        ...
        public void ProcessRequest()
        {
            ...
            {
                httpResponse = new TextResult(ex.Message, HttpResponseStatusCode.BadRequest);
            }
            catch (Exception ex)
            {
                httpResponse = new TextResult(ex.Message, HttpResponseStatusCode.InternalServerError);
            }
